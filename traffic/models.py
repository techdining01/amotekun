...
class TrafficFlow(models.Model):
    ...
    road = models.ForeignKey('Road', on_delete=models.CASCADE, related_name='traffic_flows')
...
class TrafficCamera(models.Model):
    ...
    monitored_road = models.ForeignKey(Road, on_delete=models.SET_NULL, null=True, blank=True)
    direction = models.CharField(max_length=50, blank=True, help_text="e.g., Northbound")
