...
class NotificationService:
    ...
    def send_to_officers_nearby(
        self, lat, lon, radius_km, notification_type, title, message, data=None
    ):
        """
    ...
    def _send_to_user(self, user, data):
        ...
        try:
            async_to_sync(self.channel_layer.group_send)(
                group_name, {"type": "notification", **data}
            )
        except RedisTimeoutError:
            # Redis timed out; skip real-time delivery but keep notification stored
            pass
        except Exception:
            pass
